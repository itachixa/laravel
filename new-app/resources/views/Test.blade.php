...
$(document).ready(function(){
            ...
            success: function(response) {
                ...
                response.forEach(user => {
                    rows += `<tr>
                        ...
                        <td>${user.phone}</td>
                        <td>
                            <a href="#editUserModal" class="edit" data-toggle="modal" data-id="${user.id}" data-name="${user.name}" data-email="${user.email}" data-phone="${user.phone}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
    ...
    $(document).on('click', '.edit', function() {
        ...
        $('#editUserId').val(id);
        $('#editUserForm [name="name"]').val(name);
        $('#editUserForm [name="email"]').val(email);
        $('#editUserForm [name="phone"]').val(phone);
    });
